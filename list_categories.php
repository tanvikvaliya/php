...
<!-- Mirrored from wireframes.php-dev.in/training/v1.2/php/assignment/list_categories.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Nov 2020 06:15:51 GMT -->
<head>
...
<div id="wrapper">
 ...
 <!--header-starts-->
  ...
  <!-- Content Section Start-->
	<form method="POST" enctype="multipart/form-data" action="dlt1.php">
	...
	<div class="container">
		<div class="filable_form_container">
				...
				<table width="100%">
					...
					<tbody>
						...
						if (!isset ($_GET['page']) ) {
						 ...
						 $query1 = "SELECT * FROM category order by id desc LIMIT " . $page_first_result . ',' . $results_per_page;
						$result1 = mysqli_query($con, $query1);
								...
								?>
                <td>
                  <input type="checkbox" class="case" name="chk[]" value="<?php echo $row['id']; ?>" /> <label class="css-label mandatory_checkbox_fildes" for="checkbox_sample19"></label>
                </td>
                <?php
            ...
            ?>
                <td>
    <div class="buttons">
      <a href="dlt1.php?did=<?php echo $row['id'] ?>" class="btn btn_edit" name="dltbtn">Delete</a>
			...
			<div class="pagination_listing">
				<ul>
					...
					for($page = 1; $page<= $number_of_page; $page++) {
						echo '<li><a href = "list_categories.php?page=' . $page . '">' . $page . ' </a></li>';
					}
					?>
				</ul>
			</div>
...
<!-- Mirrored from wireframes.php-dev.in/training/v1.2/php/assignment/list_categories.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Nov 2020 06:16:14 GMT -->
</html>
