...
<!-- Mirrored from wireframes.php-dev.in/training/v1.2/php/assignment/add_product.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Oct 2020 05:45:16 GMT -->
<head>
...
$(document).ready(function() {
  ...
  function pname_check(){
    ...
    if(pname==""){
      $('#pnamecheck').show();
      $('#pnamecheck').html("Please Fill Product Name*");
      $('#pnamecheck').focus();
      pname_err = false;
      return false;
    }
  ...
  function price_check(){
    ...
    if(price ==""){
      $('#pricecheck').show();
      $('#pricecheck').html("Please Fill Price*");
      $('#pricecheck').focus();
      price_err = false;
      return false;
    }
...
<div id="wrapper">
 ...
 <!--header-starts-->
  ...
  <form action="addpro.php" method="post" enctype="multipart/form-data" autocomplete="off">
	...
	<div class="container">
		<div class="filable_form_container">
			<div class="form_container_block">
				<ul>
					<li class="fileds">
						<div class="name_fileds">
							...
							<input name="firstname" id="pname" type="text" />
              <p id="pnamecheck" style="color:red;"></p>
						</div>
					</li>
					<li class="fileds">
						<div class="name_fileds">
              ...
              <p id="pricecheck" style="color:red;"></p>
						</div>
					</li>
					<li class="fileds">
						<div class="upload_fileds">
							<label>Upload Image</label>
							<input id="uploadFile" name="img1" type="file" placeholder="Choose File" class="mandatory_fildes">
						</div>
					</li>
					<li class="fileds">
						<div class="name_fileds">
              ...
              $result = mysqli_query($con,"SELECT * FROM category order by cat_name");?>
							<select name="catname" class="select category">
                <?php
              ...
              <p id="catecheck" style="color:red;"></p>
						</div>
					</li>
				</ul>
				<div class="next_btn_block">
					<div class="next_btn">
						<input type="submit" id="sbtbtn" name="submit">
					</div>
				</div>
			</div>
		</div>
